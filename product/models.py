...
class Product(models.Model):
    ...
    name = models.CharField(max_length=50, default="aToolkit")
    price = models.DecimalField(max_digits=10, decimal_places=2)
    description = models.TextField()
    buyers = models.ManyToManyField(User, related_name='bought_products', blank=True)
    tags = models.ManyToManyField(Tag, related_name='products', blank=True)
    product_picture = models.ImageField(upload_to='product_pics/', blank=True)
    product_materials = models.TextField()
